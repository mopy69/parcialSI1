<x-layouts.admin>
    ...
    <div class="bg-white overflow-hidden shadow-md rounded-lg p-6">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-semibold text-gray-900">Editar Término Académico</h1>
        </div>
            ...
            <form action="{{ route('admin.terms.update', $term) }}" method="POST">
                ...
                <div class="space-y-6">
                    ...
                    <div class="mb-4">
                        ...
                        <x-inicio.text-input id="name" name="name" type="text" class="mt-1 block w-full" :value="old('name', $term->name)" required />
                    ...
                    <div class="mb-4">
                        ...
                        <x-inicio.text-input id="start_date" name="start_date" type="date" class="mt-1 block w-full" :value="old('start_date', $term->start_date)" required />
                    ...
                    <div class="mb-4">
                        ...
                        <x-inicio.text-input id="end_date" name="end_date" type="date" class="mt-1 block w-full" :value="old('end_date', $term->end_date)" required />
