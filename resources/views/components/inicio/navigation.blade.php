                ...
                <div x-show="adminOpen" x-cloak
                    ...
                    <div>
                        <button @click="openSection = (openSection === 'datos' ? '' : 'datos')"
                            ...
                            <svg :class="{ 'rotate-180': openSection === 'datos' }" class="w-4 h-4 transform transition-transform"
                    ...
                    <div>
                        <button @click="openSection = (openSection === 'programacion' ? '' : 'programacion')"
                            ...
                            <svg :class="{ 'rotate-180': openSection === 'programacion' }" class="w-4 h-4 transform transition-transform"
                                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" />
                            </svg>
                        </button>
                        ...
                        <div x-show="openSection === 'programacion'" x-cloak
                            ...
                            <a href="{{ route('admin.course-offerings.index') }}" 
                                ...
                                <svg class="w-5 h-5 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M6 6.878V6a2.25 2.25 0 012.25-2.25h7.5A2.25 2.25 0 0118 6v.878m-12 0c.235-.083.487-.128.75-.128h10.5c.263 0 .515.045.75.128m-12 0A2.25 2.25 0 004.5 9v.878m13.5-3A2.25 2.25 0 0119.5 9v.878m0 0a2.25 2.25 0 01-2.25 2.25h-7.5a2.25 2.25 0 01-2.25-2.25v-.878m12 0A2.25 2.25 0 0019.5 9v-.878m-12 0c.235.083.487.128.75.128h10.5c.263 0 .515.045.75.128m-12 0v9A2.25 2.25 0 004.5 21h15a2.25 2.25 0 002.25-2.25v-9m-19.5 0h19.5" />
                                </svg>
                    ...
                    <div>
                        <button @click="openSection = (openSection === 'admin' ? '' : 'admin')"
                            class="w-full flex items-center justify-between px-4 py-2 text-xs font-semibold text-gray-500 uppercase tracking-wider hover:text-gray-700 focus:outline-none transition duration-150 ease-in-out">
                            <span>{{ __('Administración') }}</span>
                            <svg :class="{ 'rotate-180': openSection === 'admin' }" class="w-4 h-4 transform transition-transform"
                                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" />
                            </svg>
                        </button>
                    ...
                    <div>
                        <button @click="openSection = (openSection === 'auditoria' ? '' : 'auditoria')"
                            ...
                            <svg :class="{ 'rotate-180': openSection === 'auditoria' }" class="w-4 h-4 transform transition-transform"
                                xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" />
                            </svg>
                        </button>
                        ...
                        <div x-show="openSection === 'auditoria'" x-cloak
                            ...
                            <a href="{{ route('admin.logs.index') }}" 
                                ...
                                <svg class="w-5 h-5 flex-shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M10.125 2.25h-4.5c-1.125 0-2.062.094-2.062 2.063v15.375c0 1.125.938 2.063 2.063 2.063h12.75c1.125 0 2.063-.938 2.063-2.063V8.318c0-.52-.212-1.008-.574-1.37l-4.688-4.688A1.875 1.875 0 0011.813 2.25H10.125v-1.5zM10.125 2.25v3.375c0 .621.504 1.125 1.125 1.125h3.375z" />
                                </svg>
